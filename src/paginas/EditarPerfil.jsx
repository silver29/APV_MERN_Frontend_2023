...
// Para sacar información del state se necesita utilizar el hook creado.
...
const EditarPerfil = () => {
    ...
    const handleSubmit = async e => {
        ...
        // await bloquea el código a la siguiente línea hasta que no se tenga una respuesta de la función.
